                    ...
                    for (int j = 0; j < tuPojo.wordIndexMap.size(); j++) {
                        for (int k = 0; k < tuPojo.wordIndexMap.size(); k++) {
                            if (tuPojo.adjMatrix[j][k] > 0) {
                                ...
                                if(shortestPath.contains(tuPojo.wordIndex2Map.get(j)) && shortestPath.contains(tuPojo.wordIndex2Map.get(k))
                                        && shortestPath.indexOf(tuPojo.wordIndex2Map.get(j))>shortestPath.indexOf(tuPojo.wordIndex2Map.get(k))){
                ...
                for (int i = 0; i <tuPojo.wordIndexMap.size(); i++) {
                    for (int j = 0; j < tuPojo.wordIndexMap.size(); j++) {
                        if(tuPojo.adjMatrix[i][j]>0) {
                            ...
                            if(shortestPath.contains(tuPojo.wordIndex2Map.get(i)) && shortestPath.contains(tuPojo.wordIndex2Map.get(j))
                            && shortestPath.indexOf(tuPojo.wordIndex2Map.get(i))>shortestPath.indexOf(tuPojo.wordIndex2Map.get(j))){
                                dotGraphBuilder.addEdge(node1,node2,edge,"red");
                            }
                            else{
                                dotGraphBuilder.addEdge(node1,node2,edge,"darkgreen");
